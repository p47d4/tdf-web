...
gulp.task("html:build", function () {
  return gulp
    ...
    .pipe(
      comments(`
    WEBSITE: https://The Dada Foundation.com
    TWITTER: https://twitter.com/The Dada Foundation
    FACEBOOK: https://www.facebook.com/The Dada Foundation
    GITHUB: https://github.com/The Dada Foundation/
    `)
    )
